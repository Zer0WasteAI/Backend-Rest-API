...
class FileUploadService:
    ...
    def upload_image(self, file: FileStorage, image_type: str) -> tuple[str, str]:
        """
        ...
        """
        storage_path = self._generate_storage_path(file, image_type)
        public_url = self._upload_to_storage(file, storage_path)
        return storage_path, public_url
    
    def _generate_storage_path(self, file: FileStorage, image_type: str) -> str:
        """Genera un path único para el almacenamiento"""
